				...
				<div class="register-card-body">
					<form role="form" class="form-horizontal" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input name="phone" type="text" id="phone" class="form-control" value="${member.phone.substring(0,3) }-${member.phone.substring(3,7)}-${member.phone.substring(7)}" readonly>
							</div>
						</div>
						...
						<div class="card-footer">
							<div class="row">
								...
								<div class="col-sm-3 text-center">
									<button type="button" id="stopBtn" class="btn btn-info" style="display: ${visible};">${member.enabled eq 1 ? '정 지' : '해 제'}</button>
								</div>
								<div class="col-sm-3 text-center">
