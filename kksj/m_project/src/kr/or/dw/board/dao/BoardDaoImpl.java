...
public class BoardDaoImpl implements IBoardDao{
	...
	public int updateLike(LikeVO likeVo) {
		...
		try {
			result = client.update("board.updateLike", likeVo);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	...
	public int selectLikeCount(int bd_no) {
		...
		try {
			count = (int) client.queryForObject("board.selectLikeCount", bd_no);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	...
	public int selectUserLike(LikeVO likeVo) {
		...
		try {
			result = client.queryForObject("board.selectUserLike", likeVo);
			if(result != null) {
