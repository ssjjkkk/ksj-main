...
// 						$('#changeSelfie').append('<img class="profile-user-img img-fluid img-circle" id="" src="' + e.target.result + '">')
// 						$('#changeSelfie').append('<img class="profile-user-img img-fluid img-circle" id="" src="">')
						$('#changeSelfie img:last-child').prop('src', e.target.result);
						$('#changeSelfie img').prop('src', e.target.result);
					};	
...
// 				console.log($('#selfie'));
				let cnt = 0;
				let fileList = ($('#selfie')[0]).files;
				console.log(fileList);
				for(let file of fileList){
					cnt++;
					formData.append('selfie'+cnt, file);
					
				}
// 				console.log(formData.get('selfie1'));
// 				console.log(formData.get('selfie2'));
						...
						<div class="card-body box-profile">
							<form id="upload_form" method="post" enctype="multipart/form-data">
								<div class="text-center">
									...
									<input type="file" style="display: none;" name="selfie" id="selfie" accept=".jpg, .jpeg, .png" multiple="multiple">
