...
public class CryptoUtil {
	 ...
	 * 입력 데이터를 비트 연산, 모듈러 합 및 압축 함수를 지원하여 알아보기 힘든 더 작은 형태로 줄인다.
	 * SHA 이름의 예로는 SHA-1, SHA-2, SHA-256, SHA-512, SHA-224, SHA384가 있지만
	 * 실제로는 SHA-1 및 SHA-2의 두가지 유형이 있다.(SHA-3도 있음)
	 */
