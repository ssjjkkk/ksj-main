...
<script>
	$(function () {
		...
		function replyTemplate(reply) {
			let replySrc = "/profilePath/default/default_profile.jpg"
			...
			<div class="col-md-8">
				<div class="card card-primary card-outline">
					...
					<div class="card-footer">
						...
						<% if ( userVo != null && boardVo.getUser_no() == userVo.getUser_no() ) { %>
				...
				<div class="card" id="re_container">
					<%
						...
						for(ReplyVO replyVo : replyList) {
							if(userVo != null && userVo.getNick().equals(replyVo.getNick())) {
								hidden = "";
							}else{
								hidden = "hidden";
							}
						...
						<div class="row">
							<div class="col-md-4 d-flex">
								<div class="user-block col-md-8" >
									<img class="img-circle img-bordered-sm"	src="<%= replyVo.getPic_path() == null ? "/profilePath/default/default_profile.jpg" : "/profilePath/" + replyVo.getPic_path() %>" alt="user image">
									<span class="username">
								...
								<div class="icon-block col-md-4 align-self-center">
									...
									<a href="#" class="float-right btn-tool reply-delete-btn"><i class="fas fa-times" <%= hidden%> ></i></a>
									<a href="#" class="float-right btn-tool reply-update-btn"><i class="fas fa-pen" <%= hidden%>></i></a>
								</div>
							</div>
