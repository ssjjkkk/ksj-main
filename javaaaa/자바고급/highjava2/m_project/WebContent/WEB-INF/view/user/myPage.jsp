...
<script>
	$(function() {
		...
		$('#saveProfileBtn').on('click', function () {
			...
			/* 
				FormData 를 사용하여 <form> 태그처럼 파일을 넘기는 방식을 알아보려고 한다.
				...
				contentType은 default값이 "application/x-www-form-urlencoded; charset=utf-8"
				"multipart/form-data" 로 전송이 되게 false로 넣어준다.
				
				[요약]
				- contentType : false로 선언 시 content-type 헤더가 multipart/form-data
				- processData : false로 선언 시 formData를 String 으로 변환하지 않음
			 */
							...
							<form id="upload_form" method="post" enctype="multipart/form-data">
								<div class="text-center">
									<a href="#" id="changeSelfie">
										<img class="profile-user-img img-fluid img-circle" id="profile_picture" src="/profilePath/<%= userVo.getPic_path()%>" alt="User profile picture">
									</a>
